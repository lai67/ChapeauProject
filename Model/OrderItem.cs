...
namespace Model
{
    public class OrderItem
    {
        ...
        public Menu_Item_Model MenuItem { get; set; }
        ...
        public OrderItem(Menu_Item_Model menuItem, string comment, OrderStatus orderStatus, int count, int orderId)
        {
            MenuItem = menuItem;
            Comment = comment;
        ...
        public OrderItem(int id, Menu_Item_Model menuItem, string comment, OrderStatus orderStatus, int count,int orderId)
        {
            Id = id;
            MenuItem = menuItem;
            Comment = comment;
